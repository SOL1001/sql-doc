...
const NAV: NavItem[] = [
  ...
  { kind: "link",    id: "endpoint-4-get-apiv1productpurchase_status",              label: "4. Purchase Status"    },
  { kind: "link",    id: "endpoint-5-get-apiv1orderslist",                          label: "5. Orders List"        },
  { kind: "link",    id: "endpoint-6-get-apiv1categoryads",                         label: "6. Category Ads List"  },
  { kind: "link",    id: "endpoint-7-get-apiv1populars",                            label: "7. Popular Merchants List" },
  { kind: "link",    id: "endpoint-8-get-apiv1popular_categories",                  label: "8. Popular Categories List" },
  { kind: "link",    id: "endpoint-9-get-apiv1popular_categoriesmerchant_idstring",label: "9. Popular Categories List By Merchant" },
  { kind: "link",    id: "endpoint-10-get-apiv1popular_products",                   label: "10. Popular Products List" },
  { kind: "link",    id: "endpoint-11-get-apiv1merchantstringpopular_merchant_products", label: "11. Popular Product By Merchant" },
  { kind: "link",    id: "endpoint-12-get-apiv1merchantstringpopular_merchant_productscategorycategory_idint", label: "12. Popular Merchant Product By Category" },
  { kind: "link",    id: "endpoint-13-get-apiv1popular_categories",                 label: "13. Popular Categories" },
  { kind: "link",    id: "endpoint-14-get-apiv1popular_categoriesmerchant_idstring",label: "14. Popular Categories By Merchant" },
  { kind: "link",    id: "endpoint-15-get-apiv1searchquerystring",                  label: "15. Search Merchant"   },
  { kind: "link",    id: "endpoint-16-get-apiv1searchallquerystring",               label: "16. Search All"        },
  { kind: "link",    id: "endpoint-17-get-apiv1productssearchquerystring",          label: "17. Product Search"    },
  { kind: "link",    id: "endpoint-18-get-apiv1categoriessearchqueryquerystring",   label: "18. Category Search"   },
  { kind: "link",    id: "endpoint-19-get-apiv1total_products",                     label: "19. Total Products"    },
  ...
  { kind: "link",    id: "endpoint-26-get-apiv1categories",                         label: "26. Categories"        },
