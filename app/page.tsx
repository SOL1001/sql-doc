...
const NAV: NavItem[] = [
  ...
  { kind: "link",    id: "endpoint-1-get-apiv1wishlistuser_id",                     label: "1. Get Wishlist"       },
  { kind: "link",    id: "endpoint-2-get-apiv1orders",                              label: "2. List Orders"        },
  { kind: "link",    id: "endpoint-3-get-apiv1merchantordersorder_idstatus",        label: "3. Order Status"       },
  { kind: "link",    id: "endpoint-4-get-apiv1productproduct_idreviews",            label: "4. Product Reviews"    },
  { kind: "link",    id: "endpoint-5-get-apiv1driver",                              label: "5. Driver Tracking"    },
  { kind: "link",    id: "endpoint-8-get-apiv1delivery_products",                   label: "8. Delivery Products"  },
  { kind: "link",    id: "endpoint-8b-get-apiv1delivery_productsprod_id",           label: "8b. Single Product"    },
  { kind: "section", label: "Driver (x-token)"                                                                     },
  { kind: "link",    id: "driver-authentication-endpoints-5-6-7",                   label: "Driver Auth"           },
  { kind: "link",    id: "endpoint-5-get-apiv1driverhistory",                       label: "5. Driver History"     },
  { kind: "link",    id: "endpoint-6-get-apiv1driverorders",                        label: "6. Driver Orders"      },
  { kind: "link",    id: "endpoint-7-get-apiv1driverorderorder_id",                 label: "7. Order Detail"       },
  { kind: "section", label: "Reference"                                                                            },
  { kind: "link",    id: "table-reference",                                          label: "Table Reference"      },
  { kind: "link",    id: "jsonb-name-columns",                                       label: "JSONB Columns"        },
  { kind: "link",    id: "updated-table-reference",                                  label: "Updated Tables"       },
]
